...
#define LOGSCALE 4
#define LOGT  11	/* logsize of a logical  TAGE tables */
#define LOGB 12	// log of number of entries in bimodal predictor
#define LOGBIAS 9  // logsize of tables in SC
...
*/
#define LOGASSOC 0
#define LOGG 11 // TAGE index width
#define ASSOC 1

#define HYSTSHIFT 1 // bimodal hysteresis shared among (1<< HYSTSHIFT) entries
#define BIMWIDTH 2  //  with of the counter in the bimodal predictor
...
#endif
*/
  current_hist.ch_t[0][i].init(current_hist.ch_i[i].OLENGTH, TBITS, i);
  current_hist.ch_t[1][i].init(current_hist.ch_i[i].OLENGTH, TBITS, i + 2);	
