module riscv_soc_top(
    ...
    logic taken;
    parameter N_TABLES   = 6;
    parameter GHR_SIZE   = 512;
    parameter BTB_SIZE   = 2048;
    parameter BIMODAL_IDX = 12;
    parameter int TAGE_HIST_LEN [N_TABLES] = '{4, 8, 16, 32, 64, 128};
    parameter int TAGE_IDX_SIZE [N_TABLES] = '{12, 12, 11, 11, 10, 10};
    parameter int TAGE_TAG_SIZE [N_TABLES] = '{8, 8, 9, 9, 10, 10};
